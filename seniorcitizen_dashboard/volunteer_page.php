...
<body class="body1">
      ...
      <div class="container-fluid">
         ...
         <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            <div class="navbar-nav mr-auto">
               ...
               <a class="nav-link active" aria-current="page" href="./volunteer_page.php"><i class="fa fa-search" aria-hidden="true"></i>Volunteer</a>

               <a class="nav-link " href="./emergency_services.php"><i class="fa fa-ambulance" aria-hidden="true"></i>Emergency Services</a>
   ...
   <table>
      ...
      $sql = "SELECT username , email , mobile FROM volunteer
      ORDER BY RAND()
LIMIT 5;";
